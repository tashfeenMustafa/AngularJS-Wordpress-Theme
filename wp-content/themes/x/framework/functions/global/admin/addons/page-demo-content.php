...
function x_addons_page_demo_content() {
  ...
  <div class="wrap x-addons-demo-content">
    ...
    <header class="x-addons-header">
      ...
      <p><?php _e( 'Quick start the design process with our Standard and Expanded demos. <a href="//community.theme.co/kb/demo-content/" target="_blank">Learn More</a>.', '__x__' ); ?></p>
    </header>
    ...
    <div class="x-addons-postboxes">
      ...
      <?php else : ?>
        ...
        $troubleshooting_info = '<p>While our Standard and Expanded demo content can be used any time, it is recommended for use on new installations as a starting point. <a href="//theme.co/go/join-demodashboard.php" target="_blank">Purchase another license</a>.</p>'
                              . '<p>If you feel you have run into a problem, check out our <a href="//community.theme.co/kb/demo-content/#troubleshooting" target="_blank">ttroubleshooting tips</a>.</p>';
...
function x_addons_page_demo_content_setup() {
  ...
  $request = wp_remote_get( 'http://themeco-demo-content.s3.amazonaws.com/x/index.json' );
